 ...
 */
package com.sarcastico.interceptors;
...
public class AuditInterceptor {
    ...
    public Object aroundInvoke(InvocationContext ic) throws Exception {
        ...
        String x = "auditor intercepted " + methodName + " at " + time;
        System.out.println(x);
        
        // save the audit message to the db
        itemService.create(null, x);
        
        /*if (methodName.equals("create")) {
        	System.out.println("auditor c");
